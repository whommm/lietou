...
class CandidateExcelService:
    ...
    def _build_record(
        ...
        return CandidateExcelRecord(
            ...
            current_title=str(values.get("当前岗位") or ""),
            current_company=str(values.get("当前公司") or ""),
            city=str(values.get("城市") or ""),
            work_years=str(values.get("工作年限") or ""),
            education=str(values.get("学历") or ""),
